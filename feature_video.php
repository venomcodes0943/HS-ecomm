            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="flex product-img-slide">
                    ...
                    <div class="product-images">
                        ...
                        <div class="e-product-button" data-fancybox href="https://www.youtube.com/watch?v=_sI_Ps7JSEk">
                            <span>Video</span>
                        </div>
                    </div>
                ...
                <div class="single-flex">
                    <div class="single-product-info product-info product-grid-v2 s-50">
                        ...
                        <div class="short-desc">
                            <p class="product-desc">Uses a dictionary of over combined with a handful of model sentence
                                ...
                                <div class="row entry-middle">
                                    <div class="entry-info col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <p>It is a long established fact that a reader will be distracted by the
                                            readable content page when looking at its layout. The point of using Lorem
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="qa-element">
                    ...
                    <div class="qa-answer">
                        ...
                        <p>As long as the players are grouped in a configuration to your liking, you can ask Alexa on
                            the Sonos One or on an echo device to start music and playback will begin across the Sonos
                            grouping. </p>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="qa-element">
                    ...
                    <div class="qa-answer">
                        <span class="qa-icon">A</span>
                        <p>Search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions
