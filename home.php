...
?>
        ...
        <div class="e-feature">
            <div class="container container-240">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 feature-item">
                        <div class="feature-block-img">
                            <img src="img/feature/b_credit.png" alt="" class="img-reponsive">
                        </div>
                        <div class="feature-info v2">
                            <h3>Safe Payment</h3>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 feature-item">
                        <div class="feature-block-img">
                            <img src="img/feature/b-tele.png" alt="" class="img-reponsive">
                        </div>
                        <div class="feature-info v2">
            ...
            <div class="container container-240">
                <div class="ecome-heading style2 spc5">
                    <ul class="product-tab-sw v2">
                        <li class="active"><a data-toggle="tab" href="#" aria-expanded="true">Products</a></li>
                    </ul>
                ...
                <div class="tab-content">
                    <div id="feature" class="tab-pane fade in active">
                        <div class="product-tab-pd js-multiple-row2">
                            <?php
                            $hsql = "SELECT * FROM `vendor_product`";
                                    ...
                                    <div class="product-item">
                                        <div class="pd-bd product-inner">
                                            <div class="product-img">
                                                <a href="#"><img src="vendor/pupload/<?php echo $hrow['p_image'] ?>" alt="" class="img-reponsive"></a>
                                            </div>
                                            <div class="product-info">
                                                ...
                                                <div class="element-list element-list-left">
                                                    <ul class="desc-list">
                                                        <li><?php echo $hrow['p_feature1'] ?></li>
                                                        <li><?php echo $hrow['p_feature2'] ?></li>
                                                        <li><?php echo $hrow['p_feature3'] ?></li>
                                                    </ul>
                                                </div>
                                                <div class="element-list element-list-middle">
                                                    ...
                                                    <h3 class="product-title"><a href="#"></a><?php echo $hrow['p_name'] ?></h3>
                                                    <div class="product-bottom">
                                                        <div class="product-price"><span>$<?php echo $hrow['p_price'] ?></span></div>
            ...
            <div class="container container-240">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="img/banner/h5_b3.jpg" alt="" class="img-responsive"></a>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="banner-img banner-img2">
                            <a href="#"><img src="img/banner/h5_b4.jpg" alt="" class="img-responsive"></a>
                            <div class="h-banner-content">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 product-item">
                                <div class="pd-bd product-inner v3">
                                    <div class="product-img v3">
                                        <a href="#"><img src="img/b-product5.jpg" alt="" class="img-reponsive"></a>
                                    </div>
                                    <div class="product-info">
                                        <div class="color-group">
            ...
            <div class="container container-240">
                ...
                <div class="owl-carousel owl-theme owl-cate v3 js-owl-cate">
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/tv3.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/snap.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                                <h3>Camera & Photo</h3>
                                <div class="abs">
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/xbox2.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/samsungbox.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                                <h3>Computers & Accessories</h3>
                                <div class="abs">
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/phone3.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                                <h3>Computers & Accessories</h3>
                                <div class="abs">
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/phone2.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                                <h3>Computers & Accessories</h3>
                                <div class="abs">
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/tv.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                                <h3>Computers & Accessories</h3>
                                <div class="abs">
                    ...
                    <div class="category-item">
                        <div class="bd-7 pd30">
                            <div class="cate-img">
                                <a href="#"><img src="img/product/tv2.jpg" alt=""></a>
                            </div>
                            <div class="cate-content">
                                <h3>Computers & Accessories</h3>
                                <div class="abs">
        ...
        <div class="container container-240">
            <div class="banner-callus spc2 spc5 image-bd effect_img2">
                <a href="#"><img src="img/banner/h5_b5.jpg" alt="" class="img-responsive"></a>
